  ...
  return (
    <div>
      ...
      <div className="row">
        ...
        <div className="col-lg-2"><i class="fas fa-plus-circle icons"></i></div>
        <div className="col-lg-5">
          <HelpCard title="2.Style Image" Image={StyleImage} alt="Style Image" />
        </div>
      </div>
      <i class="fas fa-chevron-down icons"></i>
      <div className="ResCard"><HelpCard  id="ResCard" title="3.Result Image" Image={ResultImage} alt="Result Image" /></div>
